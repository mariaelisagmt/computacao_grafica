...
//Matriz para as cores do triangulo
GLfloat cores[]=  {
	1.0f, 1.0f, 0.0f, 1.0f,
	0.0f, 2.0f, 0.8f, 1.0f,
	0.0f, 0.0f, 0.8f, 1.0f
...
{
	adicionarLinha(-0.5f, -0.5f, 0.0f, 0.0f);

	adicionarLinha(0.0f, 0.0f, 0.0f, -0.5f);
	
	adicionarLinha(0.0f, -0.5f, -0.5f, -0.5f);
